...
gulp.task('images:build', function () {
    return gulp.src(path.src.images)
        .pipe($.cache($.imagemin({interlaced: true, progressive: true, optimizationLevel: 5})))
...
gulp.task('build', gulp.parallel('json', 'html:build', 'fonts:build', 'styles:build', 'js:build', 'images:build', 'svgSprite:build'));
